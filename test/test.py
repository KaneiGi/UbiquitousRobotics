...
class test(OpenRTM_aist.DataFlowComponentBase):
	...
	def __init__(self, manager):
		...
		self._d_inport = OpenRTM_aist.instantiateDataType(RTC.TimedShort)
		"""
		"""
		self._inportIn = OpenRTM_aist.InPort("inport", self._d_inport)
	...
	def onInitialize(self):
		...
		# Set InPort buffers
		self.addInPort("inport",self._inportIn)
	...
	def onExecute(self, ec_id):
		...
		if self._inportIn.isNew():
			data=self._inportIn.read()
			print(data)
